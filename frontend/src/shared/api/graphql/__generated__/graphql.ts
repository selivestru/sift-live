...
export type LoginMutation = { __typename: 'Mutation', login: { __typename: 'AuthResponse', accessToken: string, user: { __typename: 'User', id: string, email: string, username: string, color: string } } };
...
export type RegisterMutation = { __typename: 'Mutation', register: { __typename: 'AuthResponse', accessToken: string, user: { __typename: 'User', id: string, email: string, username: string, color: string } } };
...
export type UpdateUserColorMutation = { __typename: 'Mutation', updateUserColor: { __typename: 'User', id: string, email: string, username: string, color: string } };

export type FollowedChannelsQueryVariables = Exact<{ [key: string]: never; }>;


export type FollowedChannelsQuery = { __typename: 'Query', followedChannels: Array<{ __typename: 'Channel', id: string, username: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, isFollowing: boolean, viewerCount: number, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } }> };

export type LiveChannelsQueryVariables = Exact<{ [key: string]: never; }>;


export type LiveChannelsQuery = { __typename: 'Query', liveChannels: Array<{ __typename: 'Channel', id: string, username: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, isFollowing: boolean, viewerCount: number, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } }> };
...
export type ChannelQuery = { __typename: 'Query', channel: { __typename: 'Channel', id: string, username: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, isFollowing: boolean, viewerCount: number, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } } };
...
export type FollowChannelMutation = { __typename: 'Mutation', followChannel: { __typename: 'Channel', id: string, username: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, isFollowing: boolean, viewerCount: number, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } } };
...
export type UnFollowChannelMutation = { __typename: 'Mutation', unFollowChannel: { __typename: 'Channel', id: string, username: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, isFollowing: boolean, viewerCount: number, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } } };

export type ResetStreamKeyMutationVariables = Exact<{ [key: string]: never; }>;


export type ResetStreamKeyMutation = { __typename: 'Mutation', resetStreamKey: { __typename: 'StreamKey', id: string, streamKey: string } };

export type StreamKeyQueryVariables = Exact<{ [key: string]: never; }>;


export type StreamKeyQuery = { __typename: 'Query', streamKey: { __typename: 'StreamKey', id: string, streamKey: string } };
...
export type MeQuery = { __typename: 'Query', me: { __typename: 'User', id: string, email: string, username: string, color: string } };

export type RefreshMutationVariables = Exact<{ [key: string]: never; }>;


export type RefreshMutation = { __typename: 'Mutation', refresh: { __typename: 'RefreshResponse', accessToken: string } };

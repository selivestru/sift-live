...
export type FollowedChannelsQuery = { followedChannels: Array<{ __typename: 'Channel', id: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, username: string, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } }> };

export type LiveChannelsQueryVariables = Exact<{ [key: string]: never; }>;


export type LiveChannelsQuery = { liveChannels: Array<{ __typename: 'Channel', id: string, title: string, tags: Array<string> | null, isLive: boolean, userId: string, username: string, category: { __typename: 'Category', id: string, title: string, slug: string, image: string | null } }> };
